...
export default function EditService({ service, categories }: Props) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post(`/client-admin/services/${service.id}`, { forceFormData: true });
    }
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto max-w-3xl p-6">
                <h1 className="mb-6 text-2xl font-bold">{t('edit_service')}</h1>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="vuexy-card p-6">
                        ...
                        {featuredPreview && (
                            <img src={featuredPreview} alt="Preview" className="mt-2 h-32 rounded-lg object-cover" />
                        )}
                    </div>
